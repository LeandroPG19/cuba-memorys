...
echo "  · migrations           applied against YOUR live database, not a fresh"
echo "                         one. A migration that only works on an existing"
echo "                         schema passes here and fails on a new install."
echo ""
